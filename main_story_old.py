...
class Intro():
  intro = "After a drunken night out with friends, you awaken the "
  ...
  time.sleep(1)
  choiceA = "A. Grab a nearby rock and throw it at the orc"
  choiceB = "B. Lie down and wait to be mauled"
  choiceC ="C. Run"
